...
$stmt = $db->prepare(
  'INSERT INTO reports (certificationID, empID, fname, lname, expDate, certificationName)
  VALUES (?, ?, ?, ?, ?, ?)'
);
...
// If needed, get auto-generated PK from DB
 $reportsID = $db->lastInsertId();  // https://www.php.net/manual/en/pdo.lastinsertid.php

// Step 4: Output
// Here, instead of giving output, I'm redirecting to the SELECT API,
// just in case the data changed by entering it
header('HTTP/1.1 303 See Other');
header('Location: ../reports/' . $reportsID);
